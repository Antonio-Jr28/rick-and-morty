...
const buttonStyles: Record<string, string> = {
  default:
    "text-white border-2 rounded-lg w-full h-10 text-xl hover:bg-emerald-300 hover:text-black",
  primary:
    "border-2 rounded-lg w-full h-10 text-xl text-white border-white hover:bg-emerald-300 hover:text-black",
  secondary:
