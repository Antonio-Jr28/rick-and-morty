...
export const Navbar = () => {
  ...
  return (
    <nav className="w-full h-32 m-auto bg-violet-900 shadow-md px-8 flex items-center justify-around gap-4">
      <img
      ...
      <div className="flex items-center gap-4 text-white text-2xl mt-10">
